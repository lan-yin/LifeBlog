        ...
        <Table>
          <Tr>
            ...
            <Td>
              ...
              <p>
                常常會為了學會一件事情，把自己丟到一個絕非自己舒適圈，但是卻能夠讓我學會技能的地方，最後結果通常令人滿意且有成就感。
              </p>
              <p>
                是一個務實的人，如果流程可以簡單化，就絕對不要搞得複雜。隨著科技越來越發達，幾乎各行各業都需要 IT
                部門的存在，很喜歡軟體工程師著個產業的平行文化和分享文化，只有一直堆疊技術，才不會閉門造車，才能進步。
              </p>
            </Td>
          </Tr>
          <Tr>
